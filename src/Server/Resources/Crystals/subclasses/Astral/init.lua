...
crystalType.ShellColor = BrickColor.new("Electric blue")
crystalType.ShellMaterial = "Neon"
crystalType.ShellTransparency = .5
crystalType.ShellThickness = .25

crystalType.InnerColor = BrickColor.new(Color3.new(1, 1, 1))
crystalType.InnerMaterial = "Neon"
crystalType.InnerTransparency = 0

crystalType.Light = { Color=Color3.new(1, 1, 1), Brightness=14, Range=8 }
...
crystalType.MinSpawnDistanceToOthers = 20

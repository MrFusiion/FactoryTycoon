...
treeType.BarkColor = BrickColor.new("Ghost grey")
...
treeType.TrunkDistanceUntilSpliting = {	min=9, max=12 }
...
treeType.NumSplits = { min=1, max=3 }--Number of new segments at each split. 1 is no split.

treeType.SplitAngle = {	min=0, max=30 }--Angle away fron vertical normal of parent branch

treeType.AllowableAngleBetweenSplits = { min=20, max=130 }--Value between 0 and 180 degrees

treeType.SplitUnitYComponentConstraints = {	min=0.75, max=1 }

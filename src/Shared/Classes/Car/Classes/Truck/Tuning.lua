...
--[[Engine]]
    ...
    tune.Torque      		= 7e3									-- Determines the limit of the torque that may be exerted
    tune.Power           	= 5e3									-- How much Power is used while applying torque in order to reach the desired velocity
...
--[[Steering]]
	...
	--[Steer Gyro Tuning]
	tune.SteerDamping	= 1000										-- Steering Dampening
	tune.SteerTorque	= 90000										-- Steering Force
	tune.SteerPower		= 90000										-- Steering Aggressiveness

--[[Brakes]]
	tune.BrakeForce		= 300										-- Front brake force
